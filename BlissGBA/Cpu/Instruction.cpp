...
u8 ThumbInstruction::imm7()
{
    u8 imm7 = (this->encoding) & 0x7F;
    return imm7;
}
...
u8 ThumbInstruction::opcode5()
{
    u8 op = ((this->encoding) >> 6) & 0xF;
    return op;
}
...
u8 ThumbInstruction::registerList()
{
    u8 rl = (this->encoding) & 0xFF;
    return rl;
}

u8 ThumbInstruction::R()
{
    u8 R = ((this->encoding) >> 8) & 0x1;
    return R;
}
